...
with  DAG(
    ...
    class MongoHook(BaseHook):
        ...
        def __init__(self, conn_id: str = default_conn_name) -> None:
            ...
            self.uri = 'mongodb://localhost:root@cluster0-shard-00-00.q9nwx.mongodb.net:27017/myFirstDatabase?ssl=true&replicaSet=atlas-odcqvu-shard-0&authSource=admin&retryWrites=true&w=majority'.format(
                schema = schema,
